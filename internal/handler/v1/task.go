...
type ListTasksRequest struct {
	...
	Keywords  []string `form:"keywords"`   // 可选；模糊匹配 task.video_project_name / live_material.name，多词 AND
...
// @Param        keywords    query  []string  false  "关键词数组，模糊匹配 task.video_project_name / live_material.name，多词 AND；如 keywords=发布会&keywords=春季"
